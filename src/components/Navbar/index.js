...
const Navbar = ({toggle}) => {
    ...
    return (
        ...
        <Nav scrollNav={scrollNav}>
             <NavbarContainer>
                 <NavLogo to='/' onClick={toggleHome}>Arsana </NavLogo>
                 ...
                 <NavMenu>
                     ...
                     <NavItem>
                        <NavLinks to='sign up' smooth={true} duration={500} spy={true} exact offset={-80}>Sign Up</NavLinks>
                     </NavItem>
                 </NavMenu>
                 <NavBtn>
                     <NavBtnLink to ="/signin" smooth={true} duration={500} spy={true} exact offset={-80}>Sign In</NavBtnLink>
                 </NavBtn>
             </NavbarContainer>
         </Nav>
